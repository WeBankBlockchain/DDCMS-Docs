...
- 数据目录管理：统一的数据目录管理功能，所有操作均上链存证、确保数据目录可信，提升管理和运营效率，降低接入成本。数据目录管理具体又包含用户管理、业务管理、数据目录管理、审核管理等功能。

- 数据传输过程管理：每次数据的传输过程均会上链，确保数据流通的定量、定时、定场景，实现全流程可管理可追溯可监管审计。传输过程管理具体而言，又包括授权认证、过程存证、用量统计、定价及清算等功能。

- 数据处理组件管理：提供对各种数据处理组件的管理能力，企业可按需接入和使用、避免二次开发、降低接入和使用成本。数据处理组件又包含零知识证明、联邦学习、选择性披露、隐私计算等模块。
...
Data-Brain目前由三个子工程构成，三个工程共同构建
    - **WeBankBlockchain-Data-Brain-Contract  Data-Brain合约** 
    该项目是Data-Brain的合约部分，用于对每一个相关操作进行留痕、追溯。目前包含用户管理、业务管理、数据目录管理三个功能。
    请参考 
    `Github地址 <https://github.com/WeBankBlockchain/WeBankBlockchain-Data-Brain-Contract>`_ 
    `Gitee地址 <https://gitee.com/WeBankBlockchain/WeBankBlockchain-Data-Brain-Contract>`_

    - **WeBankBlockchain-Data-Server  后端服务器** 
    ...
    - **WeBankBlockchain-Data-Brain-Front 前端展示组件**
...
.. toctree::
   ...
   :caption: 如何使用
   ./docs/quickstart.md
   ./docs/Data-Brain-Contract/index.md
   ./docs/Data-Brain-Server/index.md
   ./docs/Data-Brain-Front/index.md
